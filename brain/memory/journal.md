...
## 2026-09-16 12:15 (episode 2): Food policy Lavish + cooking bill = self-correcting food
When food_days drops below 4, the colony self-corrects IF: (1) rice harvest ETA < 1 day, (2) a grower has Growing/PlantCutting priority 1-2, (3) a cooking bill is running on a stove or campfire. The food_outlook tool's verdict "SELF-CORRECTS" means all three conditions hold. If cooking_bills is empty, queue CookMealSimple on the best station immediately. The policy "Lavish" matches MealSimple (preferability 9 < 10), so no policy change needed.
