...
1. **Tracked values** — the agent (or defaults) names engine paths; the harness samples them each step and prints the last five values with a trend arrow (`food_days 0.9→0.6→0.7→0.3→0.0 ↓`).
